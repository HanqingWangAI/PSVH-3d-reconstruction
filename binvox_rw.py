...
class Voxels(object):
    ...
    def __init__(self, data, dims=[32,32,32], translate=[0,0,0], scale=1, axis_order='xyz'):
        self.data = data
        self.dims = dims
...
def write(voxel_model, fp):
    ...
    #print('The shape of flat is',voxels_flat.shape)
    ...
    for c in voxels_flat:
        if c == state:
            ...
            if ctr == 255:
                fp.write(six.int2byte(state))
                fp.write(six.int2byte(ctr))
                ctr = 0
        else:
