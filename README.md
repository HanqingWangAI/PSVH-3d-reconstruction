...
```
In our paper, we trained two network for rendered images and real images respectively. The checkpoint of the trained models are available [here](https://drive.google.com/drive/folders/1KR__rxlhhdYZ6p98H8GSJ2e71B5flKZg?usp=share_link)(426MB). Extract the files to the root directory.
